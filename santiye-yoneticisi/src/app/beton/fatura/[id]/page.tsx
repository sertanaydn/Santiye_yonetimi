        ...
        <>
            ...
            <div className="flex flex-col h-full bg-[#f8f9fa]">
                <div className="no-print">
                    <PageHeader title={`Fatura No: ${invoice.invoice_number}`} subtitle="Beton Fatura Detayı">
                        <Button onClick={() => router.push('/beton/fatura')} variant="outline">
                        ...
                        <Table>
                            <TableHeader className="bg-red-100">
                                <TableRow>
                                    ...
                                    <TableHead className="font-bold text-right">Yakın</TableHead>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <Card className="p-6 bg-white border-neutral-200 shadow-sm">
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between text-sm">
                                    <span className="font-bold">Altın Raket:</span>
                                    <span className="font-mono font-bold">0.00 TRY</span>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="p-6 bg-green-50 border-green-200 shadow-sm">
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm pt-2 border-t border-green-300">
                                    <span className="font-bold">Toplam Çek Tutarı:</span>
