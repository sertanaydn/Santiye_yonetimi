...
import { Eye, Plus, Search, Trash2, ArrowLeft } from 'lucide-react';
...
export default function ConcreteInvoiceListPage() {
    ...
    return (
        <div className="flex flex-col h-full bg-[#f8f9fa]">
            <PageHeader title="Canbek" subtitle="Camsan / Koparan ortak beton alımları">
                <div className="flex gap-2">
                    ...
                    <Link href="/faturalar/beton/yeni">
                            ...
                            {loading ? (
                                ...
                                <TableRow key={invoice.id} className="hover:bg-neutral-50">
                                    ...
                                    <TableCell className="text-center text-red-600 font-medium">
                                        {invoice.check_due_date ? new Date(invoice.check_due_date).toLocaleDateString('tr-TR') : '-'}
                                    </TableCell>
                                    <TableCell className="text-right p-2">
                                        <div className="flex justify-end gap-2">
                                            <Link href={`/faturalar/beton/${invoice.id}`}>
