                        ...
                        <div className="flex justify-between items-center border-b-4 border-double border-neutral-800 pb-6 mb-8">
                            ...
                            <div className="text-right">
                                <div className="bg-neutral-100 p-3 rounded border border-neutral-200">
                                    ...
                                    <p className="text-lg font-mono font-bold text-neutral-900">{new Date(selectedRequest.request_date).toLocaleDateString('tr-TR')}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <table className="w-full border-collapse">
                                <tbody>
                                    <tr className="border-b border-neutral-300">
                                        ...
                                        <td className="p-4 font-medium text-lg">{selectedRequest.requester}</td>
                                    </tr>
                                    <tr className="border-b border-neutral-300">
                                    ...
                                    <tr>
                                        ...
                                        <td className="p-4 text-lg align-top text-neutral-600 italic">{selectedRequest.description || '-'}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
